...
import { OMNIDEF } from './pa_i_AutoQuoteEnglish_def.js';
import tmpl from './pa_i_AutoQuoteEnglish.html';
import tmpl_nds from './pa_i_AutoQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pa_i_AutoQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
