...
import { OMNIDEF } from './pa_i_iss_insSetupPaymentPlanEnglish_def.js';
import tmpl from './pa_i_iss_insSetupPaymentPlanEnglish.html';
import tmpl_nds from './pa_i_iss_insSetupPaymentPlanEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pa_i_iss_insSetupPaymentPlanEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
