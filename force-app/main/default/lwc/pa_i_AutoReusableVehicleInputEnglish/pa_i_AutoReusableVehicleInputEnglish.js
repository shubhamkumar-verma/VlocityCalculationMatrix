...
import { OMNIDEF } from './pa_i_AutoReusableVehicleInputEnglish_def.js';
import tmpl from './pa_i_AutoReusableVehicleInputEnglish.html';
import tmpl_nds from './pa_i_AutoReusableVehicleInputEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pa_i_AutoReusableVehicleInputEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
