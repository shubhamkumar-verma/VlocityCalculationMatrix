...
import { OMNIDEF } from './pa_i_iss_StarterIssuePolicyEnglish_def.js';
import tmpl from './pa_i_iss_StarterIssuePolicyEnglish.html';
import tmpl_nds from './pa_i_iss_StarterIssuePolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pa_i_iss_StarterIssuePolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
