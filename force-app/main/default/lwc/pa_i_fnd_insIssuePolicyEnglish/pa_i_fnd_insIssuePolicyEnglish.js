...
import { OMNIDEF } from './pa_i_fnd_insIssuePolicyEnglish_def.js';
import tmpl from './pa_i_fnd_insIssuePolicyEnglish.html';
import tmpl_nds from './pa_i_fnd_insIssuePolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pa_i_fnd_insIssuePolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
